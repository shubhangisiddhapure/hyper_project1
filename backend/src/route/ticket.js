            ...
            if(userData)
            {
                ...
                for(i=0;i<seat.length;i++)
                {
                    ...
                    if(newData.name)
                    {
                        ...
                        {
                            return res.status(400).json({msg:"You can not book this seat,some one else using this seat",selectedSeat})
                        }
                        else 
                        {
                    ...
                    else
                    {
                        ...
                        if(selectedSeat.includes(seat[i]))
                        {
                            return res.status(400).json({msg:"we can not book this seat,some one else using this seat",selectedSeat})
                        }
                        else 
                        {
                            selectedSeat.push(seat[i])
